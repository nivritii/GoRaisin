                        ...
                        <div class="section_wrapper mcb-section-inner">
                            <div class="container" style="padding-left:0px">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a data-toggle="tab" href="#menu1" style="font-size: 18px">Live Projects</a></li>
                                    <li><a data-toggle="tab" href="#menu2" style="font-size: 18px">Created Projects</a></li>
                                    <li><a data-toggle="tab" href="#menu3" style="font-size: 18px">Backed Projects</a></li>
                                </ul>
