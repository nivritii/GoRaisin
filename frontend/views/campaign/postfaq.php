                    ...
                    <form class="postFAQ" enctype="multipart/form-data" action="postfaq?id=<?= $model->c_id ?>"
                        ...
                        <div style="width: 100%;">
                            <div style="display: inline-block;float: left;margin-left: 2%;width: 100%;margin-bottom: 20px">
                                ...
                                <textarea rows="2" type="text" style="width: 100%" name="faqQn" id="faqQn" required></textarea>
                            </div>
                        </div>
                        <div style="width: 100%;">
                            <div style="display: inline-block;float: left;margin-left: 2%;width: 100%; margin-bottom: 20px">
                                <p><b>What's the answer?</b></p>
                                <textarea rows="6" type="text" style="width: 100%" name="faqAns" id="faqAns" required></textarea>
                            </div>
                        </div>
