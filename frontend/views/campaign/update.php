                            ...
                            <div class="form-group">
                                <div style="width: 100%;height: 80px">
                                    ...
                                    <div style="display: inline-block;float: left;margin-left: 2%;width: 50%">
                                        <input type="text" style="width: 100%" name="cTitle" id="cTitle" value="<?php echo $model->c_title ?>" required>
                                    </div>
                                </div>
...
<script>
    ...
    document.getElementById("cDesc").value="<?php echo $model->c_description ?>"
</script>
