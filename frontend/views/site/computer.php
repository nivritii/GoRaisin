...
<div class="tab-title-container">
    <p class="tab-title">Computers</p>
    <br />
    <div class="featured-campaign-container1">
        <p class="featured-campaign-text">FEATURED CAMPAIGN</p>
        <?= Html::img('@web/images/uploads/Hydrangeas.jpg',['class' => 'featured-campaign-image']) ?>
        <p class="featured-campaign-title">Hydrangeas</p>
        <p class="campaign-fund-progress">10% FUNDED</p>
    </div>
