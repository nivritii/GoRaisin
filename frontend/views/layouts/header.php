                            ...
                            <div class="menu_wrapper">
                                <nav id="menu" class="menu-main-menu-container">
                                    <ul id="menu-main-menu" class="menu">
                                        ...
                                        <li>
                                            <a target="_blank" href="<?=Url::to(['/campaign/new'])?>"><span><span style="padding: 0; color: #8f13a5f0;">Start Campaign</span></span></a>
                                        </li>
                                            ...
                                            <li>
                                                <div class="image-div" style="padding-top: 20px">
                                                    ...
                                                    <div class="image-div2">
                                                        ...
                                                        <a class="image-a" href="<?=Url::to(['/wallet/mywallet'])?>">Wallet</a>
                                                        <hr />
